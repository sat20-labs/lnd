...
chain services including [`btcd`](https://github.com/tinyverse-web3/btcd) (a
full-node), [`bitcoind`](https://github.com/bitcoin/bitcoin), and
[`neutrino`](https://github.com/tinyverse-web3/neutrino) (a new experimental light client). The project's codebase uses the
